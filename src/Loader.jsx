  ...
  return (
    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", width: "150px", height: "100px" }}>
      <style>
        {`
          .ajax-loader {
            ...
            font-size: 40px; /* Controls the overall size of the paws */
            width: 1em;
            height: 3em;
            color: #5b8fb9; /* App Blue */
          }
          .ajax-loader .paw {
            width: 1em;
            height: 1em;
          ...
          /* Converted SCSS loop delays */
          .ajax-loader .paw:nth-child(1) { animation-delay: 1.25s; }
          .ajax-loader .paw:nth-child(2) { animation-delay: 1s; }
          .ajax-loader .paw:nth-child(3) { animation-delay: 0.75s; }
          .ajax-loader .paw:nth-child(4) { animation-delay: 0.5s; }
          .ajax-loader .paw:nth-child(5) { animation-delay: 0.25s; }
          .ajax-loader .paw:nth-child(6) { animation-delay: 0s; }
      ...
      <svg style={{ display: "none" }}>
        <symbol id="paw-symbol" viewBox="0 0 249 209.32">
      ...
      <div className="ajax-loader">
        <div className="paw"><svg><use xlinkHref="#paw-symbol" /></svg></div>
        <div className="paw"><svg><use xlinkHref="#paw-symbol" /></svg></div>
        <div className="paw"><svg><use xlinkHref="#paw-symbol" /></svg></div>
        <div className="paw"><svg><use xlinkHref="#paw-symbol" /></svg></div>
        <div className="paw"><svg><use xlinkHref="#paw-symbol" /></svg></div>
